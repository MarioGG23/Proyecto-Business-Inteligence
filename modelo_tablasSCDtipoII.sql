...
ALTER TABLE [ventasSCDII].[dbo].[Hechos_venta] ADD PRIMARY KEY ([Pk_producto], [Pk_ciudad],[Pk_cliente],[pk_fecha_venta],[Pk_envio]);
...
SET @desde = '20110101'
SET @hasta = DATEADD(YEAR, 6, GETDATE())
SET @fecha = @desde
WHILE (@fecha < @hasta)
BEGIN
...
DELETE FROM [ventasSCDII].[dbo].[Hechos_venta];
DELETE FROM [ventasSCDII].[dbo].[Dim_producto];
DELETE FROM [ventasSCDII].[dbo].[Dim_ciudad];
DELETE FROM [ventasSCDII].[dbo].[Dim_cliente];
DELETE FROM [ventasSCDII].[dbo].[Dim_tiempo];
DELETE FROM [ventasSCDII].[dbo].[Dim_tipoEnvio];

DROP TABLE [ventasSCDII].[dbo].[Hechos_venta];
DROP TABLE [ventasSCDII].[dbo].[Dim_producto];
DROP TABLE [ventasSCDII].[dbo].[Dim_ciudad];
DROP TABLE [ventasSCDII].[dbo].[Dim_cliente];
DROP TABLE [ventasSCDII].[dbo].[Dim_tiempo];
DROP TABLE [ventasSCDII].[dbo].[Dim_tipoEnvio];
...
Select * from [ventas].[dbo].[Stage Clientes] where [Nombre_cliente] = 'Maro Castro'; 
Select * from [ventasSCDII].[dbo].[Dim_cliente] where [Nombre_cliente] = 'Maro Castro'; 


UPDATE [ventas].[dbo].[Stage tipoEnvio]
    SET Descripcion = 'Mismo día'  
    WHERE Id_formaEnvio = 'AXL-23G' 
GO


select * from [ventasSCDII].[dbo].[Hechos_venta] where Pk_cliente  = 491 and Pk_cliente  = 796;
select * from [ventasSCDII].[dbo].[Hechos_venta] where Pk_cliente  = 490;
