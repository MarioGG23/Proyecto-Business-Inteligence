...
ALTER TABLE [ventasSCDI].[dbo].[Hechos_venta] ADD PRIMARY KEY ([Pk_producto], [Pk_ciudad],[Pk_cliente],[pk_fecha_venta],[Pk_envio]);
...
DELETE FROM [ventasSCDI].[dbo].[Hechos_venta];
DELETE FROM [ventasSCDI].[dbo].[Dim_producto];
DELETE FROM [ventasSCDI].[dbo].[Dim_ciudad];
DELETE FROM [ventasSCDI].[dbo].[Dim_cliente];
DELETE FROM [ventasSCDI].[dbo].[Dim_tiempo];
DELETE FROM [ventasSCDI].[dbo].[Dim_tipoEnvio];

DROP TABLE [ventasSCDI].[dbo].[Hechos_venta];
DROP TABLE [ventasSCDI].[dbo].[Dim_producto];
DROP TABLE [ventasSCDI].[dbo].[Dim_ciudad];
DROP TABLE [ventasSCDI].[dbo].[Dim_cliente];
DROP TABLE [ventasSCDI].[dbo].[Dim_tiempo];
DROP TABLE [ventasSCDI].[dbo].[Dim_tipoEnvio];
...
UPDATE [ventasSCDI].[dbo].[Hechos_venta]
SET 
      [Id_pedido] = [Id_pedido]
...
select * from [ventasSCDI].[dbo].[Hechos_venta] where Pk_cliente = 490;
